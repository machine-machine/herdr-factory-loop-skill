...
settings_validate_agent() {
  case "$2" in claude|codex|cursor|opencode|pi|prime|zcode) return 0 ;; esac
  echo "config set: $1 must be one of: claude, codex, cursor, opencode, pi, prime, zcode" >&2; exit 2
}
