...
### 14. Context budgeting & the decomposer
...
file links. §14 adds a **context-budget layer** to the ICM factory so the orchestrator (typically
...
#### 14.2 The decomposer — `scripts/context-budget.sh`
...
#### 14.3 The Hermes hooks — awareness + restructure on demand
...
#### 14.4 Self-installer & onboarding
